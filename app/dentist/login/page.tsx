    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold text-gray-700">Dentist Portal</h2>
        </div>

        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center">Welcome Back</CardTitle>
            <CardDescription className="text-center">Sign in to your dentist account</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/dentist/register" className="text-green-600 hover:text-green-700 font-medium">
                  Join our platform
                </Link>
              </p>
            </div>
